...
//import com.example.autocompletewithdata.MainActivity;

public class TotalDealsClass extends SherlockFragment {
	...
	Cursor cursor;
	String user;
	public TotalDealsClass(String user) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		totalD=(TextView)v.findViewById(R.id.textViewshowingOnDashBoard);
