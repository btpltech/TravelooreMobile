...
public class Add_Note_Contact extends SherlockActivity {

	EditText et;
	int rowid;
	String rowName,rowEmail;
	@Override
...
rowid=getIntent().getIntExtra("extra",1);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case 3:
			...
			cv.put(Contact_table.contact_detail_notes_contact_table_id, rowEmail);
