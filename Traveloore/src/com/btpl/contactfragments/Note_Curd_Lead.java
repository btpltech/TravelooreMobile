...
public class Note_Curd_Lead extends SherlockActivity {
		...
		public boolean onOptionsItemSelected(MenuItem item) {
			...
			case 31 :
				...
				String where = Contact_table.contact__notes_id + "=" + id;
				//String where = Contact_table.contact_detail_notes_contact_table_id + " = '" + rowName + "'";
				Uri uri = Uri.parse("content://com.btpl.database.MyDbProvider/contact_notes_lead/" + id);
